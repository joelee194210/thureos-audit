...
type RedFlagLog struct {
	ID              primitive.ObjectID `bson:"_id,omitempty" json:"id"`
	RedFlagID       primitive.ObjectID `bson:"red_flag_id" json:"redFlagId"`
	PreviousStatus  RedFlagStatus      `bson:"previous_status" json:"previousStatus"`
	NewStatus       RedFlagStatus      `bson:"new_status" json:"newStatus"`
	...
	RedFlagSnapshot RedFlag            `bson:"red_flag_snapshot" json:"redFlagSnapshot"`
